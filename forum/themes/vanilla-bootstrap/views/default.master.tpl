...
<!--custom_menu = trenutno - označi vse kot prebrano -->
    ...
    <footer class="page-footer sticky-footer">
      <div class="container">
        ...
        <p class="pull-left">{t c="Avtorske pravice"} &copy; {$smarty.now|date_format:"%Y"}
           <a href="https://ubuntu.si">Ubuntu.Si</a>
        </p>
	<p class="pull-right hidden-xs">
             <a href="https://github.com/vanilla/vanilla">Vanilla</a> {t c="+"} <a href="https://github.com/kasperisager/vanilla-bootstrap">Bootstrap for Vanilla</a> {t c="="} <i class="InformSprite Heart"></i>
        </p>

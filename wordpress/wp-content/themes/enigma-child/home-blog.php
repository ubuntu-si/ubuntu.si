		  ...
		  <?php 	if ( have_posts()) :
				...
				<div class="col-md-4 col-sm-12 scrollimation scale-in d2 pull-left">
					<div class="enigma_blog_thumb_wrapper">
						...
						<?php } ?>
						<?php the_excerpt( __( 'Preberite več' , 'weblizar' ) ); ?>
						<a href="<?php the_permalink(); ?>" class="enigma_blog_read_btn"><i class="fa fa-plus-circle"></i><?php _e('Preberite več','weblizar'); ?></a>
